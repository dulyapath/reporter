...
<%    String pageName = "รายงานวิเคราะห์การขายและกำไรขั้นต้น-ALL";
    String pageCode = "R00000003";
...
//    request.setAttribute("css", Arrays.asList("../css/sweetalert.css", "../css/bootstrap-datetimepicker.min.css"));
    request.setAttribute("js", Arrays.asList("../js/reporter/report3.js", "../js/_globals.js"));
                    ...
                    <div class="x_panel">
                        <div class="x_content">
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                                        <label for="date_begin " class="txt-date_begin">จากวันที่</label>
                                ...
                                <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control " id="date_end" type="date" style="height:34px">
                                    </div>
                                </div>
                                <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 col-md-3">
                                    <div class="form-group">
                                        <label for="department_codex">รหัสแผนก</label>
                                        <select class="form-control selectdepartx" id="department_codex" style='width: 100%;height: 100%'></select>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
