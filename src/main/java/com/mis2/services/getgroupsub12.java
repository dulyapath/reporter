 ...
 * @author SML-DEV-PC5
 */
@WebServlet(urlPatterns = {"/getGroupsub2"})
public class getgroupsub12 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String __query = "select code,name_1,ic_group_sub_code from ic_group_sub2 where ic_group_sub_code = '" + keyword + "'order by code";
