 ...
 * @author SML-DEV-PC5
 */
@WebServlet(urlPatterns = {"/getShelf"})
public class getshelf extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String __query = "select code,name_1 from ic_shelf where whcode='" + keyword + "' order by code";
